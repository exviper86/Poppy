...
class MultimediaPage(BasePage):
    ...
    def _create_content(self, layout: QVBoxLayout):
        ...
        self._show_cover_label = Label("Показывать обложку")
        self._show_cover_labeled = LabeledSwitchTr()
        self._show_cover_card = Card(self._show_cover_label, self._show_cover_labeled)
        content_layout.addWidget(self._show_cover_card)
        ...
        self._show_buttons_label = Label("Показывать кнопки")
        self._show_buttons_labeled = LabeledSwitchTr()
        self._show_buttons_card = Card(self._show_buttons_label, self._show_buttons_labeled)
        content_layout.addWidget(self._show_buttons_card)
    ...
    def _bind(self):
        ...
        Binding.bool(self._show_cover_labeled.switch(), config.media_window.show_cover)
        Binding.bool(self._show_timeline_labeled.switch(), config.media_window.show_timeline)
        Binding.bool(self._show_buttons_labeled.switch(), config.media_window.show_buttons)
    ...
    def _update_text(self):
        ...
        self._show_cover_label.setText(loc.tr(trans.media_show_cover))
        self._show_timeline_label.setText(loc.tr(trans.media_show_timeline))
        self._show_buttons_label.setText(loc.tr(trans.media_show_buttons))
